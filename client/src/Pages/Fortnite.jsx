...
import bg from "../assets/fortnite.jpg";
import FortniteImageCard from "../Components/FortniteImageCard";
import FortniteGridImages from "../Components/FortniteGridImages";
import FortniteAvaiableModes from "../Components/FortniteAvaiableModes";
...
export const loader = async () => {
  try {
    const [fortniteResponse] = await Promise.all([
      customFetch.get("/games/name/fortnite"),
    ]);
    return {
      fortnite: fortniteResponse.data.games || [],
    };
  } catch (error) {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Join the action in your ideal mode and claim the ultimate victory!
              Whether you're a casual gamer looking for a fun and laid-back
              experience or a competitive player ready to demonstrate your
              exceptional skills, our platform offers a diverse selection of
              game modes designed to match your budget and personal style.
            </Typography>
          </Box>
        </Box>
        <Typography
        ...
        >
          <FortniteContext.Provider value={fortnite}>
            <FortniteImageCard cards={fortnite} />
